...
public class Prob07 {
    ...
    public static void main(String[] args) {
        ...
        Map<String, List<String>> map = numbers.stream()
                .collect(Collectors.groupingBy(fruit -> fruit.getFruitName().substring(0, 1),
                        Collectors.mapping(f -> f.getFruitName(), Collectors.toList())));
