...
public class PrintEx {
    public static void main(String[] args) {
        ...
        */
        ...
        //정수 ___123을 printf() 출력하고 싶다
        // 6자리 정수 출력, 왼쪽 빈자리 공백
        System.out.printf("%6d\n", 123);

        //정수 123___을 printf() 출력하고 싶다
        // 6자리 정수 출력, 오른쪽 빈자리 공백
        System.out.printf("%-6d\n", 123);

        //정수 000123을 printf() 출력하고 싶다
        // 6자리 정수 출력, 왼쪽 빈자리 0으로 채우기
        System.out.printf("%06d\n", 123);

        System.out.println("=============실수 표현=============");

        // 정수 7자리 + 소수점 + 소수2자리, 왼쪽 빈자리 공백, ----123.45
